      ...
      <Section id="life-teaser" className="bg-black/30 relative overflow-hidden" padding="lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 hidden-element">
          <div className="group relative aspect-square overflow-hidden rounded-xl cursor-pointer">
            ...
            {/* <OptimizedImage src="/lovable-uploads/TEAM CULTURE.jpg" alt="NB Media team culture" loading="lazy" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" /> */}
            <img src="/lovable-uploads/TEAM CULTURE.jpg" alt="NB Media team culture" loading="lazy" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
          ...
          <div className="group relative aspect-square overflow-hidden rounded-xl cursor-pointer">
            <div className="absolute inset-0 bg-gradient-to-t from-nbdark via-transparent to-transparent z-10"></div>
            <img src="/lovable-uploads/behind_the_scene_index.jpg" alt="NB Media office" loading="lazy" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
            <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
          ...
          <div className="group relative aspect-square overflow-hidden rounded-xl cursor-pointer">
            <div className="absolute inset-0 bg-gradient-to-t from-nbdark via-transparent to-transparent z-10"></div>
            <img src="/lovable-uploads/funactivity.jpg" alt="NB Media studio" loading="lazy" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
            <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
